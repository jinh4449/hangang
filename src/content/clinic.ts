...
export const CLINIC = {
   ...
   * 검색엔진 소유확인 코드.
   *
   * 네이버 서치어드바이저와 구글 서치콘솔에 사이트를 등록할 때, 「이 사이트가
   * 정말 당신 것인가」를 확인하는 값이다. 각 사이트에서 발급받아 여기 적으면
   * 첫 화면의 <head> 에 실린다. 확인이 끝난 뒤에도 지우면 안 된다 —
   * 지우면 소유확인이 풀려 수집이 멈춘다.
   *
   * TODO: 발급받아 채울 것. 비워 두면 태그가 나가지 않는다.
   */
  verification: {
    ...
    google: "AP-scCHLip_TP8dkRcjEro8dKBZ6-VQ4QOMJ0NSPC4k" as string | null,
  },
  /**
